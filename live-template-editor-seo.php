<?php
/*
 * Plugin Name: Live Template Editor SEO
 * Version: 1.0
 * Plugin URI: https://github.com/rafasashi
 * Description: Another Live Template Editor seo.
 * Author: Rafasashi
 ...
 */
	...
	*/
	...
	if( function_exists('LTPLE_Client') ){
		...
		/**
		 * Returns the main instance of LTPLE_SEO to prevent the need to use globals.
		 *
		 * @since  1.0.0
		 * @return object LTPLE_SEO
		 */
		function LTPLE_SEO ( $version = '1.0.0' ) {
			
			$instance = LTPLE_Client::instance( __FILE__, $version );
			
			if ( empty( $instance->seo ) ) {
				
				$instance->seo = new stdClass();
				
				$instance->seo = LTPLE_SEO::instance( __FILE__, $instance, $version );
			}
